...
- `final_bgm.mp3` - the fixed looping background track from wave 201 onward;
  currently a placeholder copy of the authorized `background/background.mp3`;
...
redistribution with this repository. Confirm the rights for any replacement
tracks added later.
