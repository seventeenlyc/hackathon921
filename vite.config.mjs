 ...
 *
 * The former build-time music/playlist injection and player-story extraction
 * were removed with the licensed demo assets and the story feature
 * (2026-09-25 de-branding); the client no longer expects those `define`s.
 */
