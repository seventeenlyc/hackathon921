...
const STRINGS: { [key: string]: Entry } = {
    ...
    // 登录浮窗：装饰性文案是固定双语视觉元素，zh/en 同值；功能性文案按语言切换。
    'gate.brand': {zh: 'SECTION 9 // TACTICAL NETWORK', en: 'SECTION 9 // TACTICAL NETWORK'},
    'gate.brandSub': {zh: '公安九课・战术指挥终端', en: '公安九课・战术指挥终端'},
    'gate.systemOnline': {zh: 'SYSTEM // ONLINE', en: 'SYSTEM // ONLINE'},
    'gate.title': {zh: 'PROTECT THE LAUGHING MAN', en: 'PROTECT THE LAUGHING MAN'},
    'gate.titleSub': {zh: 'A TACHIKOMA DEFENSE PROTOCOL', en: 'A TACHIKOMA DEFENSE PROTOCOL'},
    'gate.identTitle': {zh: 'OPERATOR IDENTIFICATION // 作战人员识别', en: 'OPERATOR IDENTIFICATION // 作战人员识别'},
    'gate.identEn': {zh: 'Enter your operator profile to access the Tachikoma Tactical Network.', en: 'Enter your operator profile to access the Tachikoma Tactical Network.'},
    'gate.identZh': {zh: '选择你的作战档案，接入塔奇克马战术网络。', en: '选择你的作战档案，接入塔奇克马战术网络。'},
    'gate.profileTitle': {zh: '01 // OPERATOR PROFILE', en: '01 // OPERATOR PROFILE'},
    'gate.profileSub': {zh: '选择头像', en: '选择头像'},
    'gate.codenameTitle': {zh: '02 // CODENAME', en: '02 // CODENAME'},
    'gate.codenameSub': {zh: '作战代号', en: '作战代号'},
    'gate.placeholder': {zh: '输入你的作战代号', en: 'ENTER YOUR CODENAME'},
    'gate.random': {zh: '随机档案 / RANDOM PROFILE', en: '随机档案 / RANDOM PROFILE'},
    'gate.continue': {zh: '接入系统 / ACCESS', en: '接入系统 / ACCESS'},
    'gate.footerLeft': {zh: 'PUBLIC SECURITY SECTION 9', en: 'PUBLIC SECURITY SECTION 9'},
    'gate.footerRight': {zh: 'TACHIKOMA LINK // STANDBY', en: 'TACHIKOMA LINK // STANDBY'},
    'gate.invalid': {zh: '代号无效 — 请输入 1–16 个有效字符。', en: 'INVALID CODENAME — Use 1–16 valid characters.'},
    'gate.avatar.aramaki': {zh: '课长', en: '课长'},
    'gate.avatar.kusanagi': {zh: '少校', en: '少校'},
    'gate.avatar.batou': {zh: '巴特', en: '巴特'},
    'gate.avatar.togusa': {zh: '托古萨', en: '托古萨'},
    'gate.avatar.ishikawa': {zh: '石川', en: '石川'},
    'gate.avatar.saito': {zh: '斉藤', en: '斉藤'},
    'gate.avatar.paz': {zh: '帕兹', en: '帕兹'},
    'gate.avatar.boma': {zh: '波马', en: '波马'},
