...
const STRINGS: { [key: string]: Entry } = {
    ...
    'ghost.title': {zh: '幽灵状态', en: 'GHOST STATUS'},
    'directive.eyebrow': {zh: '战术指令', en: 'TACTICAL DIRECTIVE'},
    'directive.title': {zh: '幽灵指令', en: 'DIRECTIVE TO GHOST'},
    'flux.title': {zh: '幽灵变动日志', en: 'GHOST FLUX'},
    ...
    'database.tabTachikoma': {zh: '塔奇克马 // 思考战车', en: 'TACHIKOMA // THINKING TANKS'},
    'database.tabHostile': {zh: '敌性体 // 属性库', en: 'HOSTILE // ATTRIBUTES'},
